...
## Data
The 251 annotated WSIs are made openly available for anyone on [DataverseNO](https://doi.org/10.18710/TLA01U). Alternatively, the data can be downloaded directly from Google Drive (to download, click [here](https://drive.google.com/drive/folders/1eUVs1DA1UYayUYjr8_aY3O5xDgV1uLvH?usp=sharing)). However, go to [DataverseNO](https://doi.org/10.18710/TLA01U) to see how to cite the IBDColEpi dataset.
